        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          >
            ...
            <p className="mt-4 text-gray-800 max-w-3xl">
              Established in 2008 under Sri Durga Malleswari Educational
              Society, NRIIT provides quality technical education and fosters
              research across Engineering, Science and Management. The campus is
              set on 20 acres of mango groves on the Vijayawada–Nuziveedu State
              Highway, offering a calm, green learning environment and easy
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <span
                className="inline-flex items-center px-3 py-1.5 rounded-full text-1xl font-medium border"
                ...
                {["overview", "courses", "facilities"].map((t) => (
                  <li key={t}>
                    <button
                      ...
                      style={{
                        borderColor: tab === t ? "#EB1165" : "transparent",
                        color: tab === t ? "#EB1165" : "#111827",
                      }}
                    >
                      {t === "overview"
                        ? "Overview"
            ...
            >
              {tab === "overview" && (
                <div className="prose max-w-none text-black">
                  ...
                  <p>
                    Ideally located about <strong>23 KM from Vijayawada</strong>{" "}
                    and <strong>22 KM from Gannavaram Airport</strong>, the
                    campus offers serene surroundings and is well connected by
                    college buses and public transport.
                  </p>

                  <h3 style={{ color: "#EB1165" }}>Mission</h3>
                  <p>
                    To provide strong technical foundations, promote research
                    and development, and prepare graduates to succeed in
              ...
              {tab === "courses" && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-semibold" style={{ color: "#EB1165" }}>
                      Undergraduate (B.Tech)
                    </h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="mt-2 text-black">
                      All departments are equipped with state-of-the-art labs,
                      advanced computer systems and contemporary software to
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="mt-2 text-black">
                      Well-connected campus with college buses and public
                      transport. Quiet, green environment ideal for study and
                      research.
                    </p>
                  </div>
                </div>
          ...
          <aside className="space-y-6">
            <div className="p-4 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-1xl font-bold">NRIIT at a glance</h3>
                </div>
                <div className="text-right">
                  <p className="text-1xl">20 acres</p>
                  <p className="text-1xl text-gray-600">Mango groves campus</p>
                </div>
              </div>
            ...
            <div className="p-4 rounded-lg border">
              <h4 className="font-semibold mb-3" style={{ color: "#EB1165" }}>
                Departments
              </h4>
                ...
                {Object.entries(departments).map(([group, list]) => (
                  <div key={group} className="border rounded">
                    <button
                      ...
                      onClick={() =>
                        setOpenDept(openDept === group ? null : group)
                      }
                    >
                      <span className="font-medium">{group}</span>
                      <svg
                        className={`w-4 h-4 transform ${
                          openDept === group ? "rotate-180" : ""
                        }`}
                        viewBox="0 0 20 20"
                        fill="none"
                    ...
                    {openDept === group && (
                      <div className="px-4 pb-3 text-1xl">
